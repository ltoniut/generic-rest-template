export declare const DEFAULT_AUTHOR = "Local User";
...
export declare const RDS_DATABASE_NAME = "northwind";
export declare const RDS_DATABASE_PORT = 3307;
export declare const RDS_HOST_NAME = "127.0.0.1";
