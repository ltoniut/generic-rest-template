...
function transform(options) {
    ...
    target.rdsDbName = !!target.rdsDbName ? target.rdsDbName : defaults_1.RDS_DATABASE_NAME;
    target.rdsDbPort = !!target.rdsDbPort ? target.rdsDbPort : defaults_1.RDS_DATABASE_PORT;
    target.rdsHostName = !!target.rdsHostName ? target.rdsHostName : defaults_1.RDS_HOST_NAME;
    return target;
}
